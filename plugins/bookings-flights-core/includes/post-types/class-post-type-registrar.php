...
final class Post_Type_Registrar {
	...
	private static function meta_definitions(): array {
		return array(
			...
			'baf_alert_email_status'     => self::meta_definition( __( 'Alert follow-up email status.', 'bookings-flights-core' ), array( self::TRAVEL_ALERT ), 'sanitize_key' ),
			'baf_alert_email_sent_at'    => self::meta_definition( __( 'Alert follow-up email sent timestamp.', 'bookings-flights-core' ), array( self::TRAVEL_ALERT ) ),
			'baf_alert_email_last_attempt_at' => self::meta_definition( __( 'Alert follow-up email attempt timestamp.', 'bookings-flights-core' ), array( self::TRAVEL_ALERT ) ),
			'baf_alert_updated_at'       => self::meta_definition( __( 'Alert intent update timestamp.', 'bookings-flights-core' ), array( self::TRAVEL_ALERT ) ),
