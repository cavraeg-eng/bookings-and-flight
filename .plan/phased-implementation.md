...
P12.4 note: Travelpayouts widget frame dimensions, responsive constraints, state model, disclosure placement, performance rules, and Phase 13 registry prerequisites are documented in `.plan/phase-12-widget-frame-layout-rules.md`. Future template and registry work should use those reservations instead of inventing per-widget layout behavior.
