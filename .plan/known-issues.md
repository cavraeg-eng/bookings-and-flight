...
Workaround: Treat official-plugin usage as staged for local Phase 11 testing and production-cleared only for the exact flight widget path validated in P11.3. Use Travelpayouts dashboard-generated hotel widget/table/embed code and White Label widget code inside a secured, capability-gated WordPress wrapper until an official plugin version or upstream configuration activates the HotelLook tools locally. Do not build a custom replacement flight/hotel inventory backend.
