...
Severity: Low after the P15.6 local review gate; keep watch through PR review and merge.
...
Planned fix phase: No remaining Phase 15 implementation issue after `ONE-98`; continue monitoring provider-owned Travelpayouts runtime warnings during later phases.
