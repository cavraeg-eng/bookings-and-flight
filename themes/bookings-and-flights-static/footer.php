		...
		<div class="site-footer__main">
			...
			<div class="site-footer__column site-footer__about">
				...
				<p class="site-footer__text">
					<?php bookings_and_flights_the_option( 'footer_description', '{{footer_description}}' ); ?>
				</p>
			...
			<div class="site-footer__column">
				...
				<address class="site-footer__contact">
					<p>
						...
						<?php bookings_and_flights_the_option( 'contact_address_1', '{{contact_address_line1}}' ); ?><br>
						<?php bookings_and_flights_the_option( 'contact_address_2', '{{contact_address_line2}}' ); ?>
					</p>
					<p>
						<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
							<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
						</svg>
						<a href="tel:<?php bookings_and_flights_the_attr( 'contact_phone', '{{contact_phone}}' ); ?>"><?php esc_html_e( 'Call Us', 'bookings_and_flights' ); ?></a>
					</p>
					<p>
						<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
						...
						<a href="mailto:<?php bookings_and_flights_the_attr( 'contact_email', '{{contact_email}}' ); ?>"><?php esc_html_e( 'Email Us', 'bookings_and_flights' ); ?></a>
					</p>
				</address>
			</div>
		</div>
